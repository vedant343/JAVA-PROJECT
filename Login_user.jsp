...
<html>
    ...
    <body style="margin: 0%; font-size: 30px; background-color: #EFCFA0; color:white;">
        <div class="Nav_bar" style='background-color: #6b1d22; width: 100%; height: 10%; margin-bottom: 20px'>
            <p style="text-align: center; padding-top: 20px; font-family: cursive; font-size: 40px; "> title </p>
        </div>
